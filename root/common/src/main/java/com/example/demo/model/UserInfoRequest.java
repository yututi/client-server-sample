...
@AllArgsConstructor
public class UserInfoRequest implements PageableRestRequest<UserInfo, PageableUserInfoResponse> {
	...
	@Override
	public Class<PageableUserInfoResponse> getPageableResponseType() {
		return PageableUserInfoResponse.class;
	}
}
